...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.jeemate.background_sms.BackgroundSmsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin background_sms, com.jeemate.background_sms.BackgroundSmsPlugin", e);
    }
    try {
